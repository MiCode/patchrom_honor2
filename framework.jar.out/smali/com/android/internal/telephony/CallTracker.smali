...
# instance fields
.field public backgroundCall:Lcom/android/internal/telephony/Call;

.field public callWaitingRegistrants:Landroid/os/RegistrantList;

.field public cm:Lcom/android/internal/telephony/CommandsInterface;

.field public foregroundCall:Lcom/android/internal/telephony/Call;

.field public imsCallEndedRegistrants:Landroid/os/RegistrantList;

.field public imsCallStartedRegistrants:Landroid/os/RegistrantList;

.field public imsPhone:Lcom/android/internal/telephony/PhoneBase;
...
.field public ringingCall:Lcom/android/internal/telephony/Call;

.field public state:Lcom/android/internal/telephony/Phone$State;

.field public voiceCallEndedRegistrants:Landroid/os/RegistrantList;

.field public voiceCallStartedRegistrants:Landroid/os/RegistrantList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->state:Lcom/android/internal/telephony/Phone$State;

    .line 60
    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/android/internal/telephony/CallTracker;->mIsInEmergencyCall:Z
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->voiceCallEndedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->voiceCallStartedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->imsCallEndedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->imsCallStartedRegistrants:Landroid/os/RegistrantList;
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/CallTracker;->callWaitingRegistrants:Landroid/os/RegistrantList;
...
.method public acceptCall(Lcom/android/internal/telephony/PhoneBase;)V
    .locals 3
    .parameter "incomingPhone"
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
        }
    ...
    const-string v2, "Accept with incomingphone is not supported in this CallTracker "
...
.method public acceptCall(Lcom/android/internal/telephony/PhoneBase;I)V
    .locals 3
    .parameter "phone"
    .parameter "callType"
    .annotation system Ldalvik/annotation/Throws;
    ...
    const-string v2, "Accept with CallType is not supported in this CallTracker "
...
.method public abstract canDial()Z
.end method
...
.method public dial(Ljava/lang/String;I)Lcom/android/internal/telephony/Connection;
    ...
    const-string v2, "Dial with Clirmode does not belong to CallTracker "
...
.method public dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    .locals 3
    .parameter "dialString"
    .parameter "clirMode"
    .parameter "uusInfo"
    ...
    const-string v2, "Dial with clirmode & UUSInfo does not belong to CallTracker "
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/CallDetails;)Lcom/android/internal/telephony/Connection;
    .locals 3
    .parameter "dialString"
    ...
    const-string v2, "Dial with calldetails does not belong to CallTracker "
...
.method public dial(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;)Lcom/android/internal/telephony/Connection;
    ...
    const-string v2, "Dial with UUSInfo does not belong to CallTracker "
...
.method public getConnectionByIndex(Lcom/android/internal/telephony/Call;I)Lcom/android/internal/telephony/Connection;
    .locals 4
    .parameter "call"
    .parameter "index"
    .annotation system Ldalvik/annotation/Throws;
...
.method public abstract hangup(Lcom/android/internal/telephony/Call;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
        }
...
.method public hangup(Lcom/android/internal/telephony/Connection;)V
    .locals 3
    .parameter "conn"
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public hangup(Lcom/android/internal/telephony/ConnectionBase;)V
    .locals 3
    .parameter "conn"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    const-string v2, "ConnectionBase "
...
.method hangupAllCalls(I)V
    ...
    .prologue
    .line 298
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/CallTracker;->hangupAllCallsP(I)V

    .line 299
    return-void
.end method

.method protected hangupAllCallsP(I)V
    .locals 2
    .parameter "callDomain"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    const-string v1, "hangupAllCalls is not supported in this CallTracker"
...
.method public abstract hangupConnectionByIndex(Lcom/android/internal/telephony/Call;I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
        }
...
.method public abstract hangupWaitingOrBackground()V
.end method
...
.method public isInEmergencyCall()Z
    ...
    .prologue
    .line 218
    iget-boolean v0, p0, Lcom/android/internal/telephony/CallTracker;->mIsInEmergencyCall:Z
...
.method public registerForCallWaiting(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/CallTracker;->callWaitingRegistrants:Landroid/os/RegistrantList;
...
.method public rejectCall(Lcom/android/internal/telephony/PhoneBase;)V
    .locals 2
    .parameter "phone"
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    const-string/jumbo v1, "rejectCall with PhoneBase is not supported in this CallTracker"
...
.method public separate(Lcom/android/internal/telephony/Connection;)V
    .locals 3
    .parameter "conn"
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public separate(Lcom/android/internal/telephony/ConnectionBase;)V
    .locals 3
    .parameter "conn"
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public abstract switchWaitingOrHoldingAndActive()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
        }
...
.method public unregisterForCallWaiting(Landroid/os/Handler;)V
    ...
    .prologue
    .line 253
    iget-object v0, p0, Lcom/android/internal/telephony/CallTracker;->callWaitingRegistrants:Landroid/os/RegistrantList;
