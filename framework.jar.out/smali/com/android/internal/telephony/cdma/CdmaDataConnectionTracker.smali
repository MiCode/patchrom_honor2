...
.method protected constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 76
    iput-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mDpt:Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;
    ...
    invoke-interface {v4, p0, v6, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V

    .line 128
    iget-object v4, p1, Lcom/android/internal/telephony/cdma/CDMAPhone;->mCM:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v4, p0, v6, v7}, Lcom/android/internal/telephony/CommandsInterface;->registerForDataCallListChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    .line 140
    new-instance v4, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;

    invoke-direct {v4, p1}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;-><init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    invoke-virtual {v4, p0, v5, v7}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->registerForModemProfileReady(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private triggerDataSetup(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "onRecordsLoaded(): Profiles are ready - trigger setup_data with reason: "
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    .line 756
    const-string/jumbo v3, "onDataSetupComplete isDataSetupCompleteOk"

    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 757
    iget-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    if-nez v3, :cond_1

    .line 758
    const-string/jumbo v3, "onDataSetupComplete mPreferredApn == null"
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    const-string/jumbo v4, "onDataSetupComplete setChoosedDataProfile to : "
    ...
    invoke-virtual {v3, v4}, Lcom/android/internal/telephony/cdma/CdmaDataProfileTracker;->setPreferedApnId(I)V
...
.method protected onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    invoke-virtual {p0, v7, v5, v6}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V
    ...
    const-string/jumbo v6, "setTetheredCallOn for apn:"
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/DataProfile;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v5, v7}, Lcom/android/internal/telephony/DataProfile;->setTetheredCallOn(Z)V
