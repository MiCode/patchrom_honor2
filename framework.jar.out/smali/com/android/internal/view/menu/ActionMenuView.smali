...
.method private needsDividerBefore(ILandroid/view/View;Z)Z
    ...
    invoke-interface {v1}, Lcom/android/internal/view/menu/ActionMenuView$ActionMenuChildView;->needsDividerBefore()Z
    ...
    .line 627
    .local v0, isHaveMenuItem:Z
    :goto_0
    if-nez v0, :cond_1

    if-nez p1, :cond_1

    instance-of v1, p2, Lcom/android/internal/view/menu/ActionMenuPresenter$OverflowMenuButton;
    ...
    .line 624
    .end local v0           #isHaveMenuItem:Z
    :cond_2
    const/4 v0, 0x0

    .restart local v0       #isHaveMenuItem:Z
    goto :goto_0
.end method
