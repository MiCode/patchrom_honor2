...
.method private onAgConnectionStatusUpdate(Ljava/lang/String;I)V
    ...
    const-string v2, "onAgConnectionStatusUpdate(): Address: "
...
.method private onAgWbsConfig(I)V
    ...
    const-string v3, "onAgWbsConfig(): WBS Config: "
...
.method private onAgentAuthorize(Ljava/lang/String;Ljava/lang/String;ZI)V
    ...
    const-string v8, "sap_weak_linkkey"
    ...
    const-string v10, "onAuthAgentAuthorize: uuid"
    ...
    invoke-static {v5}, Landroid/bluetooth/BluetoothUuid;->isAvrcpController(Landroid/os/ParcelUuid;)Z
    ...
    const-string v4, "sap_weak_linkkey"
    ...
    :cond_7
    sget-object v8, Landroid/bluetooth/BluetoothUuid;->PhoneBookAccess:Landroid/os/ParcelUuid;

    invoke-virtual {v5, v8}, Landroid/os/ParcelUuid;->equals(Ljava/lang/Object;)Z
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_8
    sget-object v8, Landroid/bluetooth/BluetoothUuid;->ObexObjectPush:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_9
    sget-object v8, Landroid/bluetooth/BluetoothUuid;->FileTransfer:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_d
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->SerialPort:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_e
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->DUN:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_10
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->MAP:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_11
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->MSE:Landroid/os/ParcelUuid;
    ...
    .end local v4           #service:Ljava/lang/String;
    :cond_12
    sget-object v6, Landroid/bluetooth/BluetoothUuid;->MNS:Landroid/os/ParcelUuid;
...
.method private onDeviceFound(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v3, "onDeviceFound() unable to post message to handler!"
...
.method private onSlcUpForAgConnection(Ljava/lang/String;)V
    ...
    const-string v2, "onAgSlcUp(): Address: "
