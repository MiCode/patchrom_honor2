...
.field private static final MSG_DISABLE_BT:I = 0x1
...
.field private mCpDevice:Landroid/bluetooth/BluetoothDevice;

.field private mCpSupported:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/server/BluetoothService;)V
    ...
    iput-boolean v1, p0, Landroid/server/BluetoothA2dpService;->mCpSupported:Z

    .line 79
    iput-object v3, p0, Landroid/server/BluetoothA2dpService;->mCpDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-direct {v1, p0, v3}, Landroid/server/BluetoothA2dpService$IntentBroadcastHandler;-><init>(Landroid/server/BluetoothA2dpService;Landroid/server/BluetoothA2dpService$1;)V
...
.method private declared-synchronized completeBluetoothDisable(Z)Z
    ...
    const-string v12, "completeBluetoothDisable: forceDisable = "
    ...
    invoke-static {v11}, Landroid/server/BluetoothA2dpService;->log(Ljava/lang/String;)V

    .line 248
    iget-object v11, p0, Landroid/server/BluetoothA2dpService;->mAudioDevices:Ljava/util/HashMap;
    ...
    .line 249
    const-string v10, "No active sink, nothing to do..."

    invoke-static {v10}, Landroid/server/BluetoothA2dpService;->log(Ljava/lang/String;)V

    .line 250
    iget-object v10, p0, Landroid/server/BluetoothA2dpService;->mAudioManager:Landroid/media/AudioManager;

    const-string v11, "bluetooth_enabled=false"
    ...
    invoke-virtual {p0, v11}, Landroid/server/BluetoothA2dpService;->getDevicesMatchingConnectionStates([I)Ljava/util/List;
    ...
    .line 261
    .local v6, sink:Landroid/bluetooth/BluetoothDevice;
    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "Disconnect connected sink "
    ...
    .line 262
    invoke-virtual {p0, v6}, Landroid/server/BluetoothA2dpService;->disconnectSinkInternal(Landroid/bluetooth/BluetoothDevice;)Z
    :try_end_1
    ...
    .end local v6           #sink:Landroid/bluetooth/BluetoothDevice;
    .end local v7           #sinks:Ljava/util/List;,"Ljava/util/List<Landroid/bluetooth/BluetoothDevice;>;"
    :catchall_0
    move-exception v9
    ...
    .restart local v7       #sinks:Ljava/util/List;,"Ljava/util/List<Landroid/bluetooth/BluetoothDevice;>;"
    :cond_1
    move v9, v10
    ...
    const-string v11, "Force to turn off BT now..."
    ...
    new-array v2, v10, [Landroid/bluetooth/BluetoothDevice;
    ...
    invoke-virtual {v10, v11}, Landroid/server/BluetoothService;->getObjectPathFromAddress(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 288
    invoke-direct {p0, v5}, Landroid/server/BluetoothA2dpService;->disconnectSinkNative(Ljava/lang/String;)Z

    .line 293
    :goto_4
    const/4 v10, 0x0

    invoke-direct {p0, v1, v8, v10}, Landroid/server/BluetoothA2dpService;->handleSinkStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    const-string v11, "error: A2DP SinkNative path is null"
    ...
    invoke-direct {p0, v1, v10, v11}, Landroid/server/BluetoothA2dpService;->handleSinkStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    .line 306
    const-string v10, "A2DP profile has been disconnected."
...
.method private handleSinkStateChange(Landroid/bluetooth/BluetoothDevice;II)V
    ...
    invoke-virtual {v1, v3}, Landroid/server/BluetoothA2dpService$IntentBroadcastHandler;->hasMessages(I)Z
    ...
    .line 594
    const-string v1, "MSG_DISABLE_BT is scheduled and has to be removed as disc has completed."
    ...
    invoke-virtual {v1, v3}, Landroid/server/BluetoothA2dpService$IntentBroadcastHandler;->removeMessages(I)V
...
.method private declared-synchronized onBluetoothDisable()V
    ...
    invoke-virtual {v1, v2}, Landroid/server/BluetoothA2dpService$IntentBroadcastHandler;->obtainMessage(I)Landroid/os/Message;
    ...
    invoke-virtual {v1, v0, v2, v3}, Landroid/server/BluetoothA2dpService$IntentBroadcastHandler;->sendMessageDelayed(Landroid/os/Message;J)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized onSinkPropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .line 568
    iput-object v1, p0, Landroid/server/BluetoothA2dpService;->mCpDevice:Landroid/bluetooth/BluetoothDevice;
    ...
    iput-boolean v5, p0, Landroid/server/BluetoothA2dpService;->mCpSupported:Z
    ...
    const-string/jumbo v6, "onSinkPropertyChanged: UseCP = "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Landroid/server/BluetoothA2dpService;->mCpSupported:Z
...
.method public declared-synchronized isScmstSupported(Landroid/bluetooth/BluetoothDevice;)Z
    .locals 3
    .parameter "device"
    ...
    const-string v1, "isScmstSupported("
    ...
    .line 739
    iget-boolean v0, p0, Landroid/server/BluetoothA2dpService;->mCpSupported:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
