...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    sget-boolean v6, Landroid/app/ActivityThread;->sIsHwTheme:Z

    if-eqz v6, :cond_4

    new-instance v4, Landroid/content/res/ResourcesEx;
    ...
    invoke-direct {v4, v0, v3, v6, p2}, Landroid/content/res/ResourcesEx;-><init>(Landroid/content/res/AssetManager;Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    invoke-virtual {v9}, Landroid/view/Window;->getContentViewType()I

    move-result v9

    iput v9, v3, Landroid/view/WindowManager$LayoutParams;->contentViewType:I

    .line 2660
    instance-of v9, v0, Landroid/app/NativeActivity;
