...
.method private parsePackage(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;I[Ljava/lang/String;)Landroid/content/pm/PackageParser$Package;
    ...
    .local v48, supportsSmallScreens:I
    const/16 v47, 0x1

    .local v47, supportsNormalScreens:I
    const/16 v46, 0x1

    .local v46, supportsLargeScreens:I
    const/16 v49, 0x1

    .local v49, supportsXLargeScreens:I
    const/16 v41, 0x1
    ...
    .local v50, tagName:Ljava/lang/String;
    ...
    new-instance v24, Landroid/content/pm/FeatureInfo;

    invoke-direct/range {v24 .. v24}, Landroid/content/pm/FeatureInfo;-><init>()V
    ...
    .local v52, targetVers:I
    const/16 v51, 0x0

    .local v51, targetCode:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .local v54, val:Landroid/util/TypedValue;
    if-eqz v54, :cond_1a
    ...
    .end local v51           #targetCode:Ljava/lang/String;
    .end local v52           #targetVers:I
    .end local v54           #val:Landroid/util/TypedValue;
    :cond_23
    :goto_6
    invoke-static/range {p2 .. p2}, Lcom/android/internal/util/XmlUtils;->skipCurrentTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .restart local v32       #minCode:Ljava/lang/String;
    .restart local v33       #minVers:I
    .restart local v51       #targetCode:Ljava/lang/String;
    .restart local v52       #targetVers:I
    .restart local v54       #val:Landroid/util/TypedValue;
    :cond_24
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v50           #tagName:Ljava/lang/String;
    :cond_34
    if-nez v25, :cond_35
    ...
    aget-object v43, v21, v26

    .local v43, scaleApp:Ljava/lang/String;
    move-object/from16 v0, v40
    ...
    .end local v43           #scaleApp:Ljava/lang/String;
    :cond_37
    ...
    .restart local v43       #scaleApp:Ljava/lang/String;
    move-object/from16 v0, v40
    ...
    .local v44, spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .end local v16           #NS:I
    .end local v30           #is:I
    .end local v44           #spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    ...
    .restart local v27       #implicitPerms:Ljava/lang/StringBuilder;
    iget-object v3, v4, Landroid/content/pm/PackageParser$Package;->packageName:Ljava/lang/String;
    ...
    .restart local v44       #spi:Landroid/content/pm/PackageParser$SplitPermissionInfo;
    :cond_42
    const/16 v28, 0x0
